...
class Todo {
  constructor(title, description, dueDate, priority) {
    ...
    this.dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.format)(new Date(dueDate), "dd/MM/yyyy");
