...
function createTodo(
  ...
  const dueDateFormatted = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(todo.dueDate, "dd/MM/yyyy");
...
function renderProjectTodos(projectName = "Default") {
  ...
  projectTodos.forEach((todo) => {
    ...
    const dueDateSpan = createSpan((0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)(todo.dueDate, "dd/MM/yyyy"));
